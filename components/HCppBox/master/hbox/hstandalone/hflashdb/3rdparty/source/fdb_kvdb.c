...
#define SECTOR_STORE_OFFSET                      ((uintptr_t)(&((struct sector_hdr_data *)0)->status_table.store))
#define SECTOR_DIRTY_OFFSET                      ((uintptr_t)(&((struct sector_hdr_data *)0)->status_table.dirty))
...
#define KV_MAGIC_OFFSET                          ((uintptr_t)(&((struct kv_hdr_data *)0)->magic))
#define KV_LEN_OFFSET                            ((uintptr_t)(&((struct kv_hdr_data *)0)->len))
#define KV_NAME_LEN_OFFSET                       ((uintptr_t)(&((struct kv_hdr_data *)0)->name_len))
